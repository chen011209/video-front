<!-- <template>
  <div>
    <el-upload class="upload-demo" :http-request="uploadVideo">
      <el-button slot="trigger">选取上传视频</el-button>
    </el-upload>

    <el-upload class="upload-demo" :http-request="uploadPicture">
...
<script>
import { upload } from "../services/video.js";
export default {
  data() {
    return {
      videoPath: "",
