  ...
  <div style="display: flex; gap: 50px">
    <el-carousel>
      <el-carousel-item v-for="i in imgs">
        <img :src="i" @load="imgLoad" @click="test(i)" />
      </el-carousel-item>
    </el-carousel>
    <div>
      <el-card class="box-card">
        ...
        <div v-for="o in 10" :key="o" class="text item" style="width: 500px">
          {{
            "List item " + o
          }}gsdfghsrthsrhtgsdfghsrthsrhtfghsrthsrhtgsdfghsrthsrht
        </div>
      </el-card>
    </div>
  </div>
  ...
  methods: {
    ...
    async getMovList() {
      try {
        ...
        for (var i = 0; i < 5; i++) {
          this.imgs.push(this.movieList[i].picturePath);
        }
