...
import { register, getMailCode, registerAdmin } from "../services/user.js";
const ruleFormRef = ref<FormInstance>();
var isShow = localStorage.getItem("userType") === "0";
...
const submitAdmin = (formEl: FormInstance | undefined) => {
  if (!formEl) return;
  formEl.validate(async (valid) => {
    if (valid) {
      try {
